# software-art
**Assignment 3** <br /> <br />
Starting from 2019, an unnamed pneumonia was reported making an appearance on earth. Since then, the epoch of COVID-19 started. This piece was inspired by the era of pandemics we currently experienced. The concept behind this game is roughly simple. At first, there are only one or two case(s) of COVID-19. However, as time goes by, more and more regions, more and more countries were intruded by the viruses. Hence, the number of cases increases faster and faster, in an exponential manner. Entering a steady phase, the rate of the increase of viruses will become constant. The protagonist of this game is a doctor, one being responsible for wiping out all the viruses appearing on the screen. <br />

This game is trying to restore the real circumstance under pandemics. In terms of the rule, viruses will appear on the screen from time to time. They will appear faster and faster as time passes and finally enters a steady phase. The doctor wipes out the virus by approaching it or stepping on it. As the virus is killed, the score will increase by one. There will be a parameter that counts the number of viruses remaining on the screen. As the number exceeds 20, the game is over. Additionally, if the doctor goes out of the screen, the game is also over. Time, score, and instructions are written in the left corner of the screen. Users can press key ‘w’, ‘s’, ‘a’, and ‘d’ to move up, down, left, and right respectively. <br />

Virus class is created with a default position -300, -300, which initially will not be shown on the screen. Each virus is resized by 40 x 40 once appeared on the screen. A vector with given capacity is used to store all the viruses. As a clash is being detected, the virus will be moved out of the screen as it disappears. The clash will be tested by constantly checking the distance between the doctor and individual virus. In total, there are three stages. In the first stage of the game, when the duration is less than 10 seconds, the “generating speed” is 5. The speed is controlled by this parameter, which divides duration to get the modulus. In the second stage of the game, when duration exceeds 10 seconds and is less than 20 seconds, the “generating speed” is 3. In the third stage, the final phase, the “generating speed” is 1. That is to say, for each second, a new virus will show on the screen. Beyond 20 seconds, the “generating speed” will not change, as how it works in real case scenario when countries all over the world started to control the increase of cases. <br />

The background is in light pink, which mimics the skin or body tissues. The image of pixel COVID-19 is loaded. I selected an image in green, trying to create a contrast with the background so that the viruses may seem to be more prominent to see. The same logic can be applied to the selection of the image of the doctor. <br />

The link of video is: https://drive.google.com/file/d/1YWvWcCQyeg1gZu0wTbFlqWtuRLNpAGIV/view?usp=sharing
<img width="1018" alt="WX20220506-224528@2x" src="https://user-images.githubusercontent.com/102908435/167201479-ec7f9469-3814-4ebf-af1a-8b1d2dc736fa.png">
<img width="1019" alt="WX20220506-224553@2x" src="https://user-images.githubusercontent.com/102908435/167201487-35c06c98-70bc-47f5-8473-7ef2582f90e5.png">
<img width="1012" alt="WX20220506-224600@2x" src="https://user-images.githubusercontent.com/102908435/167201496-dc3b523e-49da-4e3a-8591-ea4a3cc8d2e8.png">
